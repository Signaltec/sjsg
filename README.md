...
* Используйте точное сравнение без приведения типов: **===** и **!==**;
* Используйте **Boolean(...)** вместо двойного отрицания (**!!**) ;
* Приводите к числу с помощью оператора **+**,
  также можно **parseInt**, но не забываете о радиксе: `parseInt(arg, radix)`.
...
* Переменные должны быть объявлены вверху;
...
* Не используйте имена, которые уже определенны во внешней области видимости.
